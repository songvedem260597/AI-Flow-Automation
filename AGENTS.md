...
4. Preserve stable rules already documented in AGENTS.md.
...
7. Provide the required completion report already defined in this AGENTS.md.
...
Ngoài AGENTS.md, các file nguy hiểm **bắt buộc** có comment ngay đầu file:
