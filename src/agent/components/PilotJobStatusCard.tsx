    ...
    <div className="rounded-xl border border-white/[0.065] bg-white/[0.02] px-3 py-2.5">
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2"><p className="truncate text-[9px] font-semibold text-white/65">Pilot {job.kind} · attempt {job.attempt}</p><span className="text-[7px] uppercase tracking-[0.08em] text-white/26">{job.status}</span></div>
          ...
          {job.error && <p className="mt-1 text-[8px] leading-3.5 text-red-200/58">{job.error}</p>}
        </div>
