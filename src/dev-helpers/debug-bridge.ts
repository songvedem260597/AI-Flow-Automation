...
// no-op immediately — that guard is the very first statement.

if (document.documentElement.hasAttribute('data-flow-bridge-real-installed')) {
  // Real bridge has installed and marked the page. Do nothing.
} else {
